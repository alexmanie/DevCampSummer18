...
//
//    var contacts = Contacts.FromJson(jsonString);
...
namespace sesion1_pratica.Models
{
    ...
    public partial class Contacts
    {
        public static List<Contacts> FromJson(string json) => JsonConvert.DeserializeObject<List<Contacts>>(json, sesion1_pratica.Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this List<Contacts> self) => JsonConvert.SerializeObject(self, sesion1_pratica.Models.Converter.Settings);
    }
